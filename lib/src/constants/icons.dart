...
class SvgIcons {
  ...
  static const returnIcon = '$_basePath/return.svg';
  ...
  static const minus = "$_basePath/minus.svg";
  static const add = "$_basePath/add.svg";
  static const photoCamera = "$_basePath/photo_camera.svg";
